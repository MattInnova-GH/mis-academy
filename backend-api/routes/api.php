...
// Libro de Reclamaciones - públicas (usadas por el formulario del front)
Route::post('/reclamaciones', [\App\Http\Controllers\ReclamacionController::class, 'store']);
Route::get('/reclamaciones/buscar', [\App\Http\Controllers\ReclamacionController::class, 'buscar']);
 
// Libro de Reclamaciones - panel admin (agrega aquí tu middleware de auth, ej. EnsureAdmin)
Route::middleware(['auth:sanctum', EnsureAdmin::class])->group(function () {
